...
export default function ProjectCards({ ProjectName, ProjectImage, videoSrc, projectLink, dataAos, projectDate, Bgcolor, ImgWidth }) {
  ...
  return (
    <a href={projectLink} target="_blank">
      <div className="group transition-all duration-300 gap-y-[5px]">
        ...
        <div className="flex justify-between items-center bg-[#00000005]  w-full p-6 rounded-[18px]">
